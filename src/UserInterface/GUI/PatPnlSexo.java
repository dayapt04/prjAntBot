...
public class PatPnlSexo extends JPanel implements ActionListener {
    ...
    private void btnGuardarClick(ActionEvent e) throws Exception {
        boolean sexoNull = (sexo == null);
        if (JOptionPane.showConfirmDialog(this, "¿Seguro que desea guardar?",
                (sexoNull) ? "Agregar..." : "Actualizar...",
                JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
    ...
    private void showTable() throws Exception {
        ...
        // BorderFactory.createEtchedBorder(), " SEXO ", TitledBorder.CENTER,
        // TitledBorder.TOP));
     ...
     * FormDesing : pat_mic
     ************************/
    private PatLabel lblTitulo = new PatLabel("SOLDADO"),
    ...
    private PatButton btnIni = new PatButton(" |< "),
